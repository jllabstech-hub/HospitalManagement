...
export default async function AdminContentPage() {
  ...
  const modules = [
    ...
    { title: 'Specialities', href: '/admin/specialities', count: specialityCount, description: 'Manage clinical specialities and outpatient programmes' },
    { title: 'Centres of Excellence', href: '/admin/centres', count: centreCount, description: 'Manage centres of excellence and clinical focus areas' },
    { title: 'Hospital Services', href: '/admin/services', count: serviceCount, description: 'Manage hospital services and patient amenities' },
    { title: 'Health Packages', href: '/admin/health-packages', count: healthPackageCount, description: 'Manage health checkup and wellness packages' },
    { title: 'Health Library (Articles)', href: '/admin/health-library', count: healthArticleCount, description: 'Manage health education articles and blogs' },
    { title: 'News & Announcements', href: '/admin/news', count: newsArticleCount, description: 'Manage hospital news, press releases, and events' },
    { title: 'Success Stories', href: '/admin/success-stories', count: successStoryCount, description: 'Manage patient testimonials and success stories' },
    { title: 'FAQs', href: '/admin/faqs', count: faqItemCount, description: 'Manage frequently asked questions' },
    { title: 'Patient Resources', href: '/admin/patient-resources', count: patientResourceCount, description: 'Manage downloadable forms and patient guides' },
